...
<div>  
    <div class='wefreshMobile'>
      <div>
        <div id='mobNav' >
        <div class="image-container">
      <img src={navBack} alt="Your Image" width={"100%"} style={{position:"absolute",top:"-80px"}}/>
      <div className="logo">
        <img src={logo1} />
  </div>
  <div className='menu' >
...
<br></br>
<div>
    <span style={{color:"white",  position:"absolute", left:"25%", right:"20%", fontSize:"24px"}} > Available on </span>
  </div>
  <br></br>
  <br></br>
  <div className='logos' >
...
<div>
  ...
  {/* <div>
  <img src={mobImage} style={{height:"450px", width:"70%", position:"absolute", left:"15%"}} />
      <img src={fill6} style={{position:"relative", left:"10%", right:"10%"}} />
    
    </div> */}
    <br></br>
    <div style={{ position: "relative", height: "450px", width: "70%", left: "16%", bottom:"270px" }}>
...
<div>
  ...
  <div style={{position:"relative", top:"-150px",textAlign:"center", fontSize:"26px", color:"#68BAE3"}} >
    ...
    >
      ...
      <div style={{ position: "relative", height: "450px", width: "70%", left: "13%" }}>
