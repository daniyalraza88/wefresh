...
<div style={{backgroundImage:`url(${fill1})`, backgroundRepeat:"no-repeat", position:"relative", right:"0px", bottom:"50px", backgroundPosition:"right", backgroundSize:"400px", height:"500px"}} >
...
<div id='screen4'   >
  ...
  <Form style={{display:"flex"}} >
<Form.Control type="email" placeholder="Enter your area" style={{fontSize:"14px",width:"65%", height:"27px", marginRight:"5px", borderRadius:"2px"}} />
&nbsp;<button style={{borderStyle:"none", width:"105px", backgroundColor: "#FFD476"}} > Send </button>
  ...
  <div id='div2'   >
    ...
    <img src={boyWorking} style={{width:"400px",position:"relative", left:"380px", zIndex:"1"}}  />
    <img src={fill4} style={{position:"relative", top : "130px", right: "50px"}} />
    </div>
  </div>
...
<img src={mobImage} style={{height:"540px", width:"291px"}} />
    ...
    <div id='screen3' style={{backgroundImage:`url(${circleBackground})`, backgroundRepeat:"no-repeat", position:"relative", right:"0px", backgroundSize:"44%"}} >
      <div  >
...
<br></br>
      ...
      <div id='quickAnswers' >
        <div> <h5>Lorem ipsum dolor sit</h5> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris. </div> <br></br>
        <div> <h5>Lorem ipsum dolor sit</h5> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris. </div>  <br></br>
        <div> <h5>Lorem ipsum dolor sit</h5> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris. </div>
...
<div style={{height:"650px", width:"80%", position:"relative", left:"20%"}} >
  <div style={{width:"50%", position:"absolute", top:"36%", left:"7%"}} >

<br></br> <h2 style={{ fontSize:"35px"}} >Find us in these <b>Area</b> </h2><br></br>
  <Form style={{display:"flex"}} >
...
<div style={{position:"relative", width:"65%", height:"100%", left:"35%"}} >
<img src={fill1} height={"80%"} style={{position:"absolute", right:"0px", bottom:"50px"}} />
<img src={fill4} height={"50%"} style={{position:"absolute", top:"240px", left:"110px"}}/>
<img src={boyWorking}  style={{position:"absolute", width:"50%", top:"150px", left:"200px" }}/>
...
<br></br>
  ...
  <div id='screen5' style={{display:"flex", justifyContent:"space-between"}}  >
<div>
<br>
</br><br>
...
<div>
  <img src={mobBack1} style={{position:"relative", top:"-200px", opacity:"0.5"}} />
    ...
    <br></br>
    <div style={{ position: "relative", height: "450px", width: "70%", left: "16%", top:"-300px" }}>
  <img src={mobImage} style={{ width: "90%", height: "100%" }} />
...
<div>
  ...
  <img src={blackIphone} style={{ width: "100%", height: "100%" }} />
  ...
  <div>  
    <div className='wefreshMobileBig'>
      <div>
        <div id='mobNav' >
        <div class="image-container">
      <img src={navBack} alt="Your Image" width={"100%"} height={"500px"} style={{marginTop:"-90px"}}/>
      <div className="logo">
        <img src={logo1} />
  </div>
  <div className='menu' >
...
<div>
  <img src={mobBack1} style={{position:"relative", top:"-200px", opacity:"0.5"}} />
    ...
    <br></br>
    <div style={{ position: "relative", height: "550px", width: "70%", left: "16%", top:"-300px" }}>
  <img src={mobImage} style={{ width: "90%", height: "100%" }} />
  <img src={fill6} style={{ position: "absolute", width:"120%", top: "80%", left: "50%", transform: "translate(-50%, -50%)", zIndex: -1 }} />
</div>
...
<div>
  ...
  <div style={{position:"relative", top:"-150px",textAlign:"center", fontSize:"26px", color:"#68BAE3"}} >
    ...
    >
      ...
      <div style={{ position: "relative", height: "550px", width: "70%", left: "13%" }}>
  <img src={blackIphone} style={{ width: "90%", height: "100%" }} />
  <img src={fill6} style={{ position: "absolute", width:"120%", top: "50%", left: "50%", transform: "translate(-50%, -50%)", zIndex: -1 }} />
</div>
<br></br>
<div style={{textAlign:"left", width:"80%", left:"10%", position:"relative", fontSize:"26px", padding:"20px"}} >
